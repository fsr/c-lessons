...
\begin{frame}{Segmentation Fault}
	\begin{figure}[p]{}
		...
		\let\thefootnote\relax\footnote{\tiny "Compiler Complaint" by Randall Munroe. Licensed under \textit{Creative Commons Attribution-NonCommercial 2.5 License}}
	\end{figure} \ \\[.5cm]
	A segmentation fault is very common when working with pointers. It means you were trying to
	write on memory your program didn't own. \\
