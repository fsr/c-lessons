...
\subsection{}
\begin{frame}{Do not reinvent the wheel}
	If you split your problem into sub-problems and solve each of them in a separate function, you are on a good way. \\ \ \\
	...
	Library implementations are safer and more efficient than yours will ever be, \textit{plus} you save a lot of time using them.
\end{frame}
\begin{frame}[fragile]{The Hitchhikers Guide to the standard library}
...
\end{lstlisting} \ \\ \ \\
	The actual function implementation is linked dynamically to your program during runtime. Let us not care about that for now. \\ \ \\
...
\begin{frame}{Math exam}
	\begin{itemize}
		\item Write a program that asks the user to solve some simple mathematical tasks.
