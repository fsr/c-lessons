...
\begin{frame}[fragile]{\only<1>{Remember the main \textit{function}?}%
	...
	\begin{textblock}{7}(1.5,3.5)
		\begin{tikzpicture}[x=1.2cm,y=.5cm]
			\only<3>{\draw[red] (-.3,0) edge[out=270,in=90,->,shorten >=0ex] (0,-2);}
			\uncover<4->{\draw (-.3,0) edge[out=270,in=90,->,shorten >=0ex] (0,-2);}
			\only<4>{\draw[red] (3.5,0) edge[out=270,in=90,->,shorten >=0ex] (2.25,-2);}
			\uncover<5->{\draw (3.5,0) edge[out=270,in=90,->,shorten >=0ex] (2.25,-2);}
			\only<5>{\draw[red] (7,0) edge[out=270,in=90,->,shorten >=.0ex] (4.5,-2);}
			\uncover<6->{\draw (7,0) edge[out=270,in=90,->,shorten >=.0ex] (4.5,-2);}
		\end{tikzpicture}
	\end{textblock}
	\ \\\ \\\ \\
    \begin{onlyenv}<1>
...
\end{lstlisting}
	...
	\begin{textblock}{7}(.5,5.2)
		\begin{tikzpicture}
			\only<6>{\draw[red] (1.5,0) edge[out=90,in=180,->,shorten >=0ex] (0,2);}
