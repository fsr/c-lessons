...
\end{lstlisting}
	\end{itemize}
	\uncover<2->{Just kidding}\\
	\uncover<3->{If you thought about iterating through the 200+ variables you defined to solve the problem, let me tell you: There is no way.}
\end{frame}
