...
\end{lstlisting}
	\begin{itemize}
		\item Includes input/output functions (and other usefull utilities) - and therefore  \textit{printf} - from the \textbf{C standard library}\ \\\ \\
...
\end{lstlisting}
	\begin{itemize}
		...
		\item Get used to the \textit{void}. It will be explained later
...
\begin{frame}[fragile]{A few words on style}
	\begin{itemize}
		...
		\item Indentation is not nessessary at all
		\item<2-> \textbf{But}...
	\end{itemize}
	\ \\
	\begin{uncoverenv}<2->
...
\begin{frame}{Much more enjoyable}
	\begin{itemize}
		...
		\item Indent every statement in the main function by one tab / 4 \textit{spaces}
