...
\begin{frame}[fragile]{gcc for Unix and Unix-like operating systems}
	Ubuntu / Debian:
...
\begin{frame}[fragile]{gcc for Windows (using \textbf{cygwin})}
...
\end{lstlisting}
	\bigskip
	Install gcc and optionally vim:
	\begin{lstlisting}[numbers=none]
...
(Preprocessing, compiling, assembling, linking)
	...
	\begin{columns}[T]
		\column{.3\textwidth}
		GNU/Linux \& \\ Mac OS X (\textbf{a.out})
		\begin{lstlisting}[numbers=none]
$ ./a.out
\end{lstlisting}
		\column{.3\textwidth}
...
\end{lstlisting}
	...
	\end{itemize}\ \\ \ \\
	Preprocessor statements have way more use cases, but they also behave very differently than pure C.\\
