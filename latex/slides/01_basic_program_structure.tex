...
\begin{frame}{Getting started}
	...
	\bigskip
	For doing programming exercise, we recommend visiting the \textit{Cyberspace}.\\
	It takes place in room E/046 on Wednesdays, from 3 to 6 pm.\\
	\bigskip
...
\end{lstlisting}
	\bigskip
	Now switch to the cygwin command line
	\begin{lstlisting}[numbers=none]
$ cygwin
\end{lstlisting}
\end{frame}
